...
/** début de la fenêtre de scan choisi par l'utilisateur (pages qui passent `editable-debut`) */
const debut = defineModel<string>('debut')

const minDebut = todayIso()
  ...
  >
    <template #description>
      ...
      <span
        v-else
        class="text-muted"
      >Aucun scan de disponibilités pnr-resa pour l'instant.</span>
      <span
        v-if="editableDebut"
